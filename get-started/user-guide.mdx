---
title: "User Guide"
description: "A hands-on guide for a researcher meeting defendable-science for the first time. It walks you from install to a signed finding to a submitted paper, using one…"
---
...
- **Where the reasoning lives.** Specs (the *what*) in [`docs/design/`](/design/00-meta-spec);
  ...
  [`resources/references/`](https://github.com/davorrunje/defendable-science/tree/main/resources/references); fillable staged-doc
  skeletons in [`resources/templates/`](https://github.com/davorrunje/defendable-science/tree/main/resources/templates).
