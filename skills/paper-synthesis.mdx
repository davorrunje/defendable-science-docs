...
description: "Use when developing a committed paper from its constituent hypotheses toward a publish/no-go decision and a submitted manuscript — situating it against prior work, structuring it, and assembling its…"
---
...
6. **Disclose (finalize, publish only).** Once the decision is **publish** *and* the
   ...
   deliberate (see [`../../DISCLOSURE.md`](/disclosure), ADR-0025). Keep it
