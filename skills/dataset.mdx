---
title: "dataset"
description: "Manage research datasets with a thin, git-tracked registry, tiered storage, a private rclone mirror, and SHA-256 fixity. Use when a run declares the data it needs, when adding/registering a dataset…"
---
...
ingest|emit` (Croissant) — ensure via [`ensure-tooling`](https://github.com/davorrunje/honest-scholar/blob/main/resources/ensure-tooling.md);
...
[`ensure-tooling`](https://github.com/davorrunje/honest-scholar/blob/main/resources/ensure-tooling.md); design in
