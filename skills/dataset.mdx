...
ingest|emit` (Croissant) — ensure via [`ensure-tooling`](https://github.com/davorrunje/defendable-science/blob/main/resources/ensure-tooling.md);
...
[`ensure-tooling`](https://github.com/davorrunje/defendable-science/blob/main/resources/ensure-tooling.md); design in
