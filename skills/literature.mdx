---
title: "literature"
description: "Mines and situates a research literature over one citation-graph substrate (OpenAlex + Semantic Scholar). Use when scouting the forward-citation graph for research leads (scout mode) or defending a…"
---
...
Grounding: [../../resources/references/citation-scouting.md](/references/citation-scouting).
...
Grounding: [../../resources/references/related-works-synthesis.md](/references/related-works-synthesis).
...
[../../docs/design/04-substrate-and-contract.md](/design/04-substrate-and-contract) §2). A mirror is
...
before use** via [`ensure-tooling`](https://github.com/davorrunje/honest-scholar/blob/main/resources/ensure-tooling.md) (`uv tool
