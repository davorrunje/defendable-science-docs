---
title: "defend"
description: "Use when a material research decision is about to be recorded (a findings verdict, a publish decision, a thesis defensibility judgment) or a method's rationale is undemonstrated, and whenever an…"
---
...
> [`ensure-tooling`](https://github.com/davorrunje/honest-scholar/blob/main/resources/ensure-tooling.md); it appends the
