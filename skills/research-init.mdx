---
title: "research-init"
description: "Use when onboarding a repository onto the defendable-science research workflow — either scaffolding a fresh repo (init) or backfilling an existing one that already has papers, datasets, benchmarks…"
---
...
[`resources/templates/`](https://github.com/davorrunje/defendable-science/tree/main/resources/templates); every hypothesis/paper/thesis
...
[ADR-0031](/decisions/0031-config-driven-cache-dir)). `.gitignore` is
