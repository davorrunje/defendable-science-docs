---
title: "honest-scholar — Decision Log (ADRs)"
description: "MADR-style Architecture Decision Records for the honest-scholar plugin. Each records the context, the options considered, the rejected alternatives and why, and…"
---
...
| [0019](/decisions/0019-public-plugin-visibility) | Public plugin, named `honest-scholar` | accepted |
...
| [0030](/decisions/0030-docs-site-mintlify) | Docs site on Mintlify, published from a generated docs repo to `honest-scholar.science` | accepted |
