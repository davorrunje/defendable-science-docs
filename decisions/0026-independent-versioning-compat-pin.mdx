---
title: "ADR-0026: Independent plugin/package versioning with a compatibility pin"
description: "honest-scholar ships two artifacts on different release cadences: the plugin (markdown skills, distributed via the git self-marketplace) and the honest-scholar…"
---
...
[`ensure-tooling`](https://github.com/davorrunje/honest-scholar/blob/main/resources/ensure-tooling.md) bootstrap installs/upgrades the
