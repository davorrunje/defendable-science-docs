...
description: "defendable-science ships two artifacts on different release cadences: the plugin (markdown skills, distributed via the git self-marketplace) and the…"
---
...
[`ensure-tooling`](https://github.com/davorrunje/defendable-science/blob/main/resources/ensure-tooling.md) bootstrap installs/upgrades the
