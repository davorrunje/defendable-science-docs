---
title: "ADR-0018: Git-native plain text as source of truth; cross-repo out of scope"
description: "Where does the authoritative state live — external services (Zotero DB, MLflow, W&B) or git-tracked files? And should a thesis be able to aggregate papers…"
---
