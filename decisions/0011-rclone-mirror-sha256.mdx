---
title: "ADR-0011: rclone private mirror; SHA-256 authoritative fixity"
description: "The private mirror must support Google Drive now and other backends later, keep credentials out of the repo, and verify integrity across backends whose native…"
---
