---
title: "ADR-0030: Docs site on Mintlify, published from a generated docs repo"
description: "defendable-science had no rendered docs site (#6) — the design record, README.md, docs/USER-GUIDE.md, and the CLI --help were the docs, all as in-repo markdown…"
---
