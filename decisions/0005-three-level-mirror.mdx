---
title: "ADR-0005: Three-level mirror; thesis as a partial mirror"
description: "We started with two levels (hypothesis within a paper; paper within a portfolio). The author then asked to incorporate the PhD thesis and to track progress…"
---
