---
title: "ADR-0013: Experiment-backend contract + pluggable backend"
description: "The pipeline skills need experimental evidence, but how experiments run is project-specific (one project's GPU fan-out means nothing to another's). The testing…"
---
