---
title: "ADR-0023: Delegate engineering via a contract, not a named tool"
description: "ADR-0002 kept honest-scholar scientific-only and delegated engineering to a specific named tool. But naming a specific engineering tool couples the plugin to it…"
---
