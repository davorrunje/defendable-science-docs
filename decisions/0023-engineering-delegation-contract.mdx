...
description: "ADR-0002 kept defendable-science scientific-only and delegated engineering to a specific named tool. But naming a specific engineering tool couples the plugin…"
---
