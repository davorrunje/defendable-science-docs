---
title: "ADR-0021: Thesis defensibility gate — per-gap acknowledged confirmation"
description: "The defend guardrail is everywhere else a stop-and-confirm with a single logged override (ADR-0015), to honor agency. The thesis defense is the highest-stakes…"
---
