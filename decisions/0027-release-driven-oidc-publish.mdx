---
title: "ADR-0027: Publish the package via GitHub Releases + PyPI Trusted Publishing"
description: "The honest-scholar package (ADR-0024) is distributed on PyPI, with release candidates validated on TestPyPI first. Publishing needs a trigger (when does a build…"
---
