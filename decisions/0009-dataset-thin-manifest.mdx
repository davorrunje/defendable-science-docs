---
title: "ADR-0009: dataset one skill + thin datasets.yml (reject DVC/DataLad/lakeFS)"
description: "Dataset management needs a registry + tiered retrieval + verification + a private mirror, under a light-dependency posture (mononet avoids heavy deps /…"
---
