---
title: "ADR-0024: Supporting tooling ships as one package (Typer CLI, optional MCP), bootstrapped by a markdown ensure-tooling procedure"
description: "The supporting-script TODOs (literature citation-graph client, dataset manifest + retrieval/mirror, defend record, exploration backlog) were first drafted as…"
---
...
[`ensure-tooling`](https://github.com/davorrunje/defendable-science/blob/main/resources/ensure-tooling.md) procedure: detect
