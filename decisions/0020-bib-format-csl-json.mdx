---
title: "ADR-0020: CSL-JSON as source of truth; BibTeX exported on demand"
description: "The literature registry's bibliographic-facts layer (ADR-0008) needs a concrete format. BibTeX and CSL-JSON are losslessly inter-convertible (Zotero/pandoc), so…"
---
