---
title: "ADR-0029: Unified API-key handling — a CLI-managed JSON store, not .env"
description: "The skills reach external services that key-gate their useful rate limits — Semantic Scholar (S2_API_KEY), OpenAlex (OPENALEX_MAILTO, polite pool), private…"
---
