...
description: "honest-scholar should become widely used. The mission-aligned growth vector is the honesty mission itself: research venues increasingly require an AI-use…"
---
