...
description: "A repo must be set up to use defendable-science — both fresh repos and existing ones with prior research artifacts (mononet has benchmarks, reference PDFs…"
---
