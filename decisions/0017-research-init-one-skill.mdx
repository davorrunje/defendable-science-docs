---
title: "ADR-0017: research-init one skill, init/adopt modes"
description: "A repo must be set up to use honest-scholar — both fresh repos and existing ones with prior research artifacts (mononet has benchmarks, reference PDFs, informal…"
---
