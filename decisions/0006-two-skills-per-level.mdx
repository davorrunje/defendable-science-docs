---
title: "ADR-0006: Two pipeline skills per level (generate / resolve)"
description: "How to structure the lifecycle skills so hypothesis-level and paper-level are uniform, and so the \"missing\" stages (related-works, publish-decision) fit without…"
---
