---
title: "ADR-0008: Literature registry = standard bib + triage sidecar"
description: "Should the literature registry share the dataset manifest format? A field-level comparison showed literature and dataset registries are more different than…"
---
