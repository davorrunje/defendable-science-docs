...
description: "The defendable-science package (ADR-0024) is small, pure-functional at its core, and built for reproducibility and honesty — it is the tooling an…"
---
