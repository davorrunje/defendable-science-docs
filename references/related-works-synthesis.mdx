---
title: "Positioning / Related-Works Synthesis — methodology digest"
description: "For a committed paper: systematically establish novelty, select baselines, situate the contribution. Every named method has a verified identifier below."
---
