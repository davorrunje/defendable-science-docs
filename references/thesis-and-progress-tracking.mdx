---
title: "Thesis-by-Publication & Multi-Level Progress Tracking — digest"
description: "Suggested \"done\": hypothesis = resolved (verdict backed by recorded evidence; pending = no verdict); paper = done (constituent hypotheses resolved AND claim…"
---
