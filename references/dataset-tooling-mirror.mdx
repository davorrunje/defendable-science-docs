---
title: "Dataset Tooling & Mirror Architecture — digest"
description: "Single dep-free Go binary; Google Drive + S3/B2/R2/MinIO/SFTP/WebDAV/~65 more; remote:path; verifies integrity on transfer; rclone check/hashsum on demand."
---
