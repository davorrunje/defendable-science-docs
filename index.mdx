...
> **New here?** Start with the **[User Guide](/get-started/user-guide)**.
>
...
version. See [`STATUS.md`](https://github.com/davorrunje/honest-scholar/blob/main/STATUS.md) for the current state.
