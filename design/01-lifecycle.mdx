---
title: "defendable-science sub-spec 1 — Lifecycle, pipeline skills, rigor, progress & defend"
description: "One object×action shape at three nested levels (meta-spec §3.1). Each level: a generate skill proposes candidates into a backlog; a resolve skill drives one…"
---
...
> Sub-spec of [00-meta-spec.md](/design/00-meta-spec).
...
> [sub-spec 4](/design/04-substrate-and-contract) §3
> and the `literature`/`dataset` capabilities of
> [sub-spec 2](/design/02-literature) /
> [sub-spec 3](/design/03-dataset). Governed by the ⚑ agency
...
> [thesis-and-progress-tracking](/references/thesis-and-progress-tracking),
> [understanding-and-defense](/references/understanding-and-defense),
> [mentor-personas](/references/mentor-personas).
