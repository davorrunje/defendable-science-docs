---
title: "defendable-science — Scientific Research-Workflow Plugin (Meta-Spec)"
description: "The defendable-science skills are assistants, not researchers. They keep the accounts of a research program, advise as a mentor, and discuss as a colleague…"
---
...
guardrails, in
[`resources/references/agency-principle.md`](/references/agency-principle)
and
...
- **Mentor/reviewer personas.** The examine/advise voice offers a small set of
  ...
  **Matching to an *inferred personality* is forbidden** — it is unsupported (the
  ...
  Grounded in
  [`resources/references/mentor-personas.md`](/references/mentor-personas).
