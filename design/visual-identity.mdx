...
description: "Honest Scholar's identity is built to read as rigorous, not decorative: a bold electric blue grounds the system with confidence, a single punchy red accent…"
---
...
All source files live in [`assets/`](https://github.com/davorrunje/honest-scholar/tree/main/assets):
