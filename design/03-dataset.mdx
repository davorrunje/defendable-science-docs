---
title: "defendable-science sub-spec 3 — Dataset capability (dataset)"
description: "One skill, verbs init | register | fetch | verify | mirror | audit. It is upstream of the experiment backend: runs declare the datasets they need; the skill…"
---
...
> [sub-spec 4](/design/04-substrate-and-contract) §2
> and feeds the experiment-backend contract (§3). Governed by the ⚑ agency (§2.1)
> and Understanding (§2.2) principles.
> Grounding: [dataset-management-standards](/references/dataset-management-standards),
> [dataset-tooling-mirror](/references/dataset-tooling-mirror).
