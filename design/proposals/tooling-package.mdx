---
title: "Proposal: honest-scholar package (Typer CLI, optional MCP)"
...
pure-markdown; skills call the CLI after the [`ensure-tooling`](https://github.com/davorrunje/honest-scholar/blob/main/resources/ensure-tooling.md)
procedure.
...
Install/upgrade is handled entirely by [`ensure-tooling`](https://github.com/davorrunje/honest-scholar/blob/main/resources/ensure-tooling.md):
