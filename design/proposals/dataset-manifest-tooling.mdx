---
title: "Proposal: datasets.yml manifest tooling — loader/validator + Croissant interop"
description: "Status: implemented (designed 2026-07-18) · Skill: dataset"
---
...
is installed (via [`ensure-tooling`](https://github.com/davorrunje/defendable-science/blob/main/resources/ensure-tooling.md)) the skill
