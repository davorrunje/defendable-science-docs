---
title: "defendable-science sub-spec 2 — Literature capability (literature)"
description: "One skill, two modes over one citation-graph substrate. Each mode takes a level ∈ {hypothesis, paper, thesis} parameter (the three mirror levels) that tunes…"
---
...
> Grounding: [citation-scouting](/references/citation-scouting),
> [related-works-synthesis](/references/related-works-synthesis).
